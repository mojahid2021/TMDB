package com.horizonhunters.tmdb.Activity.TvSeriesDetailsActivity;
...
public class TvSeriesDetailsActivity extends AppCompatActivity {
    ...
    private void fetchMovieDetails() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                ...
                response -> {
                    try {
                        String getTitle = response.getString("name"); // Corrected: "name" instead of "title"
                ...
                error -> {
                    Toast.makeText(TvSeriesDetailsActivity.this, "Error fetching data", Toast.LENGTH_SHORT).show();
